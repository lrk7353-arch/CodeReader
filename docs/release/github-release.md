...
```bash
git tag -a v1.0.0-rc.5 -m "CodeReader 1.0.0-rc.5"
...
```bash
node scripts/release-evidence.mjs journey-template --platform linux --arch x64 --tag v1.0.0-rc.5 --sha <40-character-commit> --output docs/release/evidence/v1.0.0-rc.5/native-journey-linux-x64.json
node scripts/release-evidence.mjs verify-journeys --input docs/release/evidence/v1.0.0-rc.5 --tag v1.0.0-rc.5 --sha <40-character-commit>
```
