...
```bash
node scripts/release-evidence.mjs journey-template --platform linux --arch x64 --tag v1.0.0-rc.6 --sha <40-character-commit> --output docs/release/evidence/v1.0.0-rc.6/native-journey-linux-x64.json
node scripts/release-evidence.mjs verify-journeys --input docs/release/evidence/v1.0.0-rc.6 --tag v1.0.0-rc.6 --sha <40-character-commit>
```
