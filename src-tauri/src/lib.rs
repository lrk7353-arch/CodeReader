...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            persistence_service::save_cognition_state,
            persistence_service::save_reading_state,
            persistence_service::save_reader_resume_state,
            persistence_service::load_reader_resume_state,
            persistence_service::create_user_annotation,
            persistence_service::update_user_annotation,
            persistence_service::delete_user_annotation,
            persistence_service::save_reader_preference,
            persistence_service::delete_reader_preference,
            persistence_service::create_related_target,
            persistence_service::update_related_target,
            persistence_service::delete_related_target,
