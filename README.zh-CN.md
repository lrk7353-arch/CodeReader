...
> 当前通道：1.0.0-rc.1 候选版。候选版用于完成完整的生产环境验证；稳定版将使用 1.0.0 版本号发布。
...
CodeReader_1.0.0-rc.1_windows_x64.msi
CodeReader_1.0.0-rc.1_linux_arm64.AppImage
~~~
...
~~~powershell
msiexec /i .\CodeReader_1.0.0-rc.1_windows_x64.msi
~~~
...
~~~bash
sudo apt install ./CodeReader_1.0.0-rc.1_linux_x64.deb
~~~
...
~~~bash
sudo dnf install ./CodeReader_1.0.0-rc.1_linux_x64.rpm
~~~
...
~~~bash
chmod +x CodeReader_1.0.0-rc.1_linux_x64.AppImage
./CodeReader_1.0.0-rc.1_linux_x64.AppImage
~~~
...
~~~powershell
Get-FileHash .\CodeReader_1.0.0-rc.1_windows_x64_setup.exe -Algorithm SHA256
Get-Content .\SHA256SUMS
gh attestation verify .\CodeReader_1.0.0-rc.1_windows_x64_setup.exe -R lrk7353-arch/CodeReader
~~~
...
gh attestation verify CodeReader_1.0.0-rc.1_linux_x64.deb -R lrk7353-arch/CodeReader
~~~
